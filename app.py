...
municipios = [
    Municipio("Benejama", history="Historia de ejemplo...", inhabitants=1800, affiliates=12),
    Municipio("Biar", history="Datos de ejemplo...", inhabitants=3600, affiliates=20),
    Municipio("Campo de Mirra", history="Contenido de ejemplo...", inhabitants=400, affiliates=5),
    Municipio("Cañada", history="Texto de ejemplo...", inhabitants=1200, affiliates=8),
    Municipio("Castalla", history="Ejemplo de contenido...", inhabitants=10500, affiliates=40),
    Municipio("Onil", history="Descripción provisional...", inhabitants=7500, affiliates=30),
    Municipio("Sax", history="Contenido inicial...", inhabitants=9500, affiliates=25),
    Municipio("Villena", history="Datos provisionales...", inhabitants=34000, affiliates=60)
]
, "Carmen Robledillo Sánchez", "29+3", "309", ["Miembro A", "Miembro B"]),
